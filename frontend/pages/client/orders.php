        ...
        <div class="flex gap-5">
            ...
            <div class="">
                ...
                <div class="flex items-center gap-2 mt-2">
                    <span class="px-3 py-1 bg-amber-100 text-amber-600 text-[10px] font-black uppercase rounded-full">
                        ' . $order['etat'] . '
                    </span>
        ...
        <div class="flex gap-2">
            <a href="view-offers.php">
                <button class="px-6 py-3 bg-slate-900 text-white rounded-xl font-bold text-sm hover:bg-slate-800 transition transform active:scale-95">
                    Voir les offres ('. (new OfferService(null, null, null, null, null, null))->OfferCountByCommande($order['id']) . ')
                </button>
            </a>
        </div>
    </div>
