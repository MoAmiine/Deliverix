...
<head>
    ...
    <title>Admin Panel | Deliverix</title>
...
<body class="bg-white flex min-h-screen">
    ...
    <aside class="w-72 border-r border-green-50 p-8 hidden lg:flex flex-col gap-10">
        <div class="flex items-center gap-3">
            <div class="w-10 h-10 bg-[#16a34a] rounded-xl flex items-center justify-center text-white font-black italic">D</div>
            <span class="text-2xl font-black text-[#064e3b]">Deliverix</span>
        </div>
        <nav class="flex flex-col gap-2">
            <a href="#" class="flex items-center gap-3 px-4 py-3 bg-green-50 text-[#16a34a] rounded-xl font-bold transition">Tableau de bord</a>
            <a href="users.html" class="flex items-center gap-3 px-4 py-3 text-slate-500 hover:bg-green-50 hover:text-[#16a34a] rounded-xl font-bold transition">Utilisateurs</a>
    ...
    <main class="flex-1 p-8 md:p-12 overflow-y-auto">
        <header class="flex justify-between items-center mb-12">
            <div>
                <h1 class="text-4xl font-black text-[#064e3b]">Supervision</h1>
                <p class="text-slate-400 font-medium">Contrôle global de la plateforme.</p>
            </div>
        ...
        <div class="bg-white rounded-[2.5rem] border border-green-50 shadow-sm overflow-hidden">
            <div class="p-8 border-b border-green-50">
                <h3 class="text-xl font-bold text-[#064e3b]">Dernières Livraisons</h3>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    <thead class="bg-green-50/30 text-slate-400 text-[10px] uppercase font-bold tracking-widest">
                        <tr>
                            <th class="px-8 py-4">Client</th>
                            <th class="px-8 py-4">Livreur</th>
